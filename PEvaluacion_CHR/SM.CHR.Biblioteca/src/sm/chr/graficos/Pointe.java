...
/**
 * Clase Pointe que representa un punto sobre el lienzo
 * @author Chris
 */

public class Pointe extends GeomShape{
     ...
     * @param rend , render. 
     */
      public Pointe(Point2D pto1, Color cl, Stroke tr, boolean alis, boolean tras, Composite compo, RenderingHints rend){
        ...
        this.comp = compo;
        this.render = rend;
        shape = new Line2D.Float(pto1, pto1);
    }
    ...
    public void updateDeShape(Point2D pto1,Point2D pto2, Point2D pto3){
        ((Line2D)shape).setLine(pto1,pto1);
    }
    ...
    public boolean isNear(Point2D p){
        return ((Line2D)shape).getP1().distance(p) <= 5.0;
    }
